...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="{{ route('classvs.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Créer une classe d'article</h1>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Créer Class valorise</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('classvs.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select name="type_article_id" class="form-control select2">
                                        ...
                                        <option value="{{ $type->id }}" {{ old('type_article_id') == $type->id ? 'selected' : '' }}>
                                            {{ $type->name }}
                                        </option>
                                        @endforeach
                                    </select>
